            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="relative group">
                  <div className="absolute -left-1.5 top-0 bottom-0 w-[1.5px] bg-[#9146FF] group-hover:w-[3px] transition-all" />
                  <div className="bg-white/5 border border-white/10 backdrop-blur-sm p-3 flex flex-col gap-2 h-full rounded-tr-xl rounded-br-xl">
                ...
                {/* Channel 2: Discord */}
                <div className="relative group">
                  <div className="absolute -left-1.5 top-0 bottom-0 w-[1.5px] bg-indigo-500 group-hover:w-[3px] transition-all" />
                  <div className="bg-white/5 border border-white/10 backdrop-blur-sm p-3 flex flex-col gap-2 h-full rounded-tr-xl rounded-br-xl">
                    <div className="flex justify-end items-center opacity-40">
              ...
              <div className="relative group">
                <div className="absolute -left-1.5 top-0 bottom-0 w-[1.5px] bg-[linear-gradient(180deg,#FF6B35_0%,#A855F7_33%,#7D67FF_66%,#00FF66_100%)] group-hover:w-[3px] transition-all opacity-90" />
                <div className="bg-white/5 border border-white/10 backdrop-blur-md p-2 px-4 flex items-center gap-4 rounded-tr-xl rounded-br-xl relative overflow-hidden transition-all hover:bg-white/10">
